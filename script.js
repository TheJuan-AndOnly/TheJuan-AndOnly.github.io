...
function writeCourseHTMLTable(x, term)
{
    ...
    if (term == 'fall') { 
        ...
        return "<div class=" + "course-selection" + "><table><tbody><tr><td class='course-selection-Name'>"+x.courseNUM + "</td><td class='course-selection-Name'>" + x.courseName + "</td><td>" + x.fallHours + "</td><td>" + x.fallDays + "</td><td>" + x.fallLocation + "</td><td>" + x.winterFaculty + "</td><td><button class='register-Button' value="+x.courseNUM+" id="+x.courseNUM+" onClick=registerCourseToProgramEvl('fall','"+x.courseNUM+"')>Register: "+x.courseNUM+"</button></td></tr></tbody></table></div>";
    }
    if (term == 'winter') {
